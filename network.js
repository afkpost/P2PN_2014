...
(function() {
  var DELETE_TOKEN, EventEmitter, FILE, FORCE_FRIEND, FRIEND, GRAPH, Network, PING, PONG, QUERY, QUERY_RESULT, UNFRIEND, xmlrpc,
  ...
  Network = (function(_super) {
    ...
    function Network(peer, log) {
      var createClient, port, sent, server, updateData,
        _this = this;
      port = peer.port;
      if (log == null) {
        log = function() {};
